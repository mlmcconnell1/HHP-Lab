...
def _build_clean_curated(base: Path) -> None:
    ...
    canonical_examples = {
        ...
        "cdc": "cdc_overdose__msa__Y2020-2025@Mcensusmsa2023xC2023.parquet",
...
class TestCanonicalFilenamesAccepted:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("census", "decennial_tracts__N2020xT2020.parquet"),
            ("census", "pl_blocks__N2020xK2020.parquet"),
            ("cdc", "cdc_overdose__county__Y2020-2025@C2023.parquet"),
            ("cdc", "cdc_overdose__msa__Y2020-2025@Mcensusmsa2023xC2023.parquet"),
            ("xwalks", "xwalk__B2025xT2023.parquet"),
