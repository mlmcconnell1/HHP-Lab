...
1. Create new ingester under its source-owned package, such as `hhplab/sources/hud/hud/` or `hhplab/sources/census/census/ingest/`
...
Add new checks in `hhplab/geographies/coc/coc_validate.py`:
