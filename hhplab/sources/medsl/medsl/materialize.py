"""Compatibility facade for materialize.
...
# ruff: noqa: E501,F405
from hhplab.sources.medsl import materialize as _impl
from hhplab.sources.medsl.materialize import *  # noqa: F401,F403

_WRAPPED_NAMES = ["materialize_county_political_leaning","build_county_political_leaning_measures","_validate_totalvotes_constant","_safe_divide","_load_declared_county_fips","_attach_county_vintage_diagnostics","_default_output_path"]
_ORIGINAL_WRAPPERS = {}
...
__all__ = ["materialize_county_political_leaning","build_county_political_leaning_measures"]
