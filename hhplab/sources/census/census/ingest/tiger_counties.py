"""Compatibility facade for tiger_counties.
...
# ruff: noqa: E501,F405
from hhplab.geographies.boundaries.census.ingest import tiger_counties as _impl
from hhplab.geographies.boundaries.census.ingest.tiger_counties import *  # noqa: F401,F403
...
_WRAPPED_NAMES = ["download_tiger_counties","save_counties","ingest_tiger_counties"]
_ORIGINAL_WRAPPERS = {}
...
__all__ = ["download_tiger_counties","save_counties","ingest_tiger_counties"]
