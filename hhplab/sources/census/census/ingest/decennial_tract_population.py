"""Compatibility facade for decennial_tract_population.
...
# ruff: noqa: E501,F405
from hhplab.sources.census.ingest import decennial_tract_population as _impl
from hhplab.sources.census.ingest.decennial_tract_population import *  # noqa: F401,F403

_WRAPPED_NAMES = ["get_output_path","fetch_decennial_tract_population","ingest_decennial_tract_population"]
_ORIGINAL_WRAPPERS = {}
...
__all__ = ["get_output_path","fetch_decennial_tract_population","ingest_decennial_tract_population"]
