"""Compatibility facade for urban_areas.
...
# ruff: noqa: E501,F405
from hhplab.geographies.boundaries.census.ingest import urban_areas as _impl
from hhplab.geographies.boundaries.census.ingest.urban_areas import *  # noqa: F401,F403

_WRAPPED_NAMES = ["urban_area_source","_year_suffix","_resolve_column","normalize_urban_areas","download_urban_areas","get_urban_area_output_path","_write_geoparquet_with_provenance","save_urban_areas","ingest_urban_areas"]
_ORIGINAL_WRAPPERS = {}
...
__all__ = ["urban_area_source","normalize_urban_areas","download_urban_areas","get_urban_area_output_path","save_urban_areas","ingest_urban_areas"]
