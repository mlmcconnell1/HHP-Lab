"""Compatibility facade for pl_block_population.
...
# ruff: noqa: E501,F405
from hhplab.sources.census.ingest import pl_block_population as _impl
from hhplab.sources.census.ingest.pl_block_population import *  # noqa: F401,F403

_WRAPPED_NAMES = ["get_pl_block_population_output_path","_api_spec","_normalize_block_response","fetch_pl_block_population","ingest_pl_block_population"]
_ORIGINAL_WRAPPERS = {}
...
__all__ = ["get_pl_block_population_output_path","fetch_pl_block_population","ingest_pl_block_population"]
