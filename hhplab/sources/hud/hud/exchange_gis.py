"""Compatibility facade for exchange_gis.
...
# ruff: noqa: E501,F405
from hhplab.geographies.boundaries.hud import exchange_gis as _impl
from hhplab.geographies.boundaries.hud.exchange_gis import *  # noqa: F401,F403
...
from hhplab.geographies.boundaries.hud.exchange_gis import (  # noqa: F401
    _HUD_STATE_ABBREVIATIONS,
    COC_ID_FIELDS,
)
from hhplab.storage.raw_snapshot import write_api_snapshot  # noqa: F401

_WRAPPED_NAMES = ["_should_use_arcgis_source","_find_field","_extract_state_from_coc_id","_get_arcgis_feature_count","_fetch_arcgis_page","_fetch_all_arcgis_features","_arcgis_features_to_geodataframe","_map_arcgis_to_canonical_schema","fetch_from_arcgis","_hash_file","_hash_directory","_hash_shapefile","_hash_local_path","_download_and_extract_zip","_download_per_state_shapefiles","download_hud_exchange_gdb","read_coc_boundaries","map_to_canonical_schema","ingest_hud_exchange"]
_ORIGINAL_WRAPPERS = {}
...
__all__ = ["fetch_from_arcgis","download_hud_exchange_gdb","read_coc_boundaries","map_to_canonical_schema","ingest_hud_exchange"]
