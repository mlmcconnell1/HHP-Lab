...
from hhplab.geographies.analysis import infer_geo_type, resolve_geo_col
...
def weighting_sensitivity(
    ...
    if not merged.empty:
        ...
        if not mismatch.empty:
            logger.warning(f"PIT totals differ between panels for {len(mismatch)} geo/year pairs")
