...
def _impl() -> ModuleType:
    return import_module("hhplab.sources.bls.laus.series")


def build_laus_series_id(cbsa_code: str, measure: str, state_fips: str) -> str:
    """Delegate to ``hhplab.sources.bls.laus.series.build_laus_series_id``."""
...
def build_all_series_ids(cbsa_code: str, state_fips: str) -> dict[str, str]:
    """Delegate to ``hhplab.sources.bls.laus.series.build_all_series_ids``."""
