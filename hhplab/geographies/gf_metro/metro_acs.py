...
def _impl() -> ModuleType:
    return import_module("hhplab.sources.census.acs.acs_metro")
...
def build_metro_tract_crosswalk(
    ...
    *,
    ...
    """Delegate to ``hhplab.sources.census.acs.acs_metro.build_metro_tract_crosswalk``."""
...
def aggregate_acs_to_metro(
    ...
    *,
    ...
    """Delegate to ``hhplab.sources.census.acs.acs_metro.aggregate_acs_to_metro``."""
