...
def validate_metro(
    ...
    from hhplab.geographies.gf_metro.metro_boundaries import validate_curated_metro_boundaries
    from hhplab.geographies.gf_metro.metro_io import validate_curated_metro
...
def validate_metro_universe(
    ...
    from hhplab.geographies.gf_metro.metro_io import validate_curated_metro_universe
