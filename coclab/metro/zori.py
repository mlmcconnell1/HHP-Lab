...
def _impl() -> ModuleType:
    return import_module("coclab.rents.metro")
...
def aggregate_zori_to_metro(
    ...
    *,
    ...
    """Delegate to ``coclab.rents.metro.aggregate_zori_to_metro``."""
...
def collapse_zori_to_yearly(
    ...
    """Delegate to ``coclab.rents.metro.collapse_zori_to_yearly``."""
...
def aggregate_yearly_zori_to_metro(
    ...
    *,
    ...
    """Delegate to ``coclab.rents.metro.aggregate_yearly_zori_to_metro``."""
